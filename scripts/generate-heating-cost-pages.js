    ...
    <section class="content-section">
        ...
        <section style="background: var(--background-secondary); border: 1px solid var(--border-color); border-radius: 8px; padding: 1.25rem; margin: 1.5rem 0;">
          ...
          <p style="margin: 0 0 0.75rem; font-size: 0.95rem;">
            Median: <strong>$${parseFloat(countyStats.median_price).toFixed(2)}/gal</strong> &middot;
        ...
        <ul>
            ...
            <li><a href="/prices/${stateAbbrev}/${countySlug}-county">${county} County Oil Prices — $${parseFloat(countyStats.median_price).toFixed(2)}/gal median</a></li>${crossLinks}
        </ul>
