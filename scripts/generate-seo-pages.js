...
function generatePageHTML(data) {
  ...
  // Heating cost cross-link (links to /heating-cost/ pages)
  ...
  if (type === 'county' && county && stateInfo) {
    ...
    <section style="background: var(--primary-orange-light); padding: 1.25rem; border-radius: 8px; margin: 2rem 0;">
      <strong>Is oil the cheapest option in ${escapeHtml(county)} County?</strong>
      Compare heating oil, natural gas, heat pump, and electric costs side by side.
      <a href="/heating-cost/${stateInfo.abbrev}/${countySlug}" style="font-weight: 600;">Compare fuels &rarr;</a>
    </section>`;
  } else if (type === 'state' && stateInfo) {
    heatingCostLinkHtml = `
    <section style="background: var(--primary-orange-light); padding: 1.25rem; border-radius: 8px; margin: 2rem 0;">
      <strong>Is oil the cheapest option in ${escapeHtml(stateInfo.name)}?</strong>
      Compare heating oil, natural gas, heat pump, and electric costs by county.
      <a href="/heating-cost/${stateInfo.abbrev}/" style="font-weight: 600;">Compare fuels &rarr;</a>
    </section>`;
  }
