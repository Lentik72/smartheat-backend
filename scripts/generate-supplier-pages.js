...
// ─── CSS Generation ────────────────────────────────────────────
// Legacy V1 styles kept for rollback safety (unused by current template).
// New V2 styles use sp- prefix to isolate from card styles in style.css.

function generateSupplierCSS() {
  return `/* ========================================
   Supplier Profile Styles
   V1 (Legacy) — kept for rollback safety
   V2 (sp- prefix) — current layout
   ======================================== */

/* --- V1 Legacy Styles (unused by current template) --- */
